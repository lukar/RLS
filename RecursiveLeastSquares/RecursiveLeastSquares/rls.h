...
class Rls
{
    std::array<std::array<double, N>, N> P_old{ { 0.0 } }, I{ { 0.0 } };
    std::array<double, N> theta_old{ 0.0 }, gamma{ 0.0 }, x{ 0.0 }, temp{ 0.0 };
    double err=0.0, y=0.0, alpha=0.0;
    double lambda = 0.99;

    double scalar(std::array<double, N> x, std::array<double, N> y) { double retv = 0; for (int i = 0; i < N; i++) { retv += x[i] * y[i]; }; return retv; }
    std::array<std::array<double, N>, N> outer_prod(std::array<double, N> x, std::array<double, N> y);
    std::array<std::array<double, N>, N> subtract_mat(std::array<std::array<double, N>, N> X, std::array<std::array<double, N>, N> Y);
    std::array<std::array<double, N>, N> product_mat(std::array<std::array<double, N>, N> X, std::array<std::array<double, N>, N> Y);
    std::array<std::array<double, N>, N> scalar_mat(double x, std::array<std::array<double, N>, N> Y);
public:
...
template<int N>
inline std::array<std::array<double, N>, N> Rls<N>::outer_prod(std::array<double, N> x, std::array<double, N> y)
{
...
template<int N>
inline std::array<std::array<double, N>, N> Rls<N>::subtract_mat(std::array<std::array<double, N>, N> X, std::array<std::array<double, N>, N> Y)
{
    std::array<std::array<double, N>, N> retv;
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
template<int N>
inline std::array<std::array<double, N>, N> Rls<N>::product_mat(std::array<std::array<double, N>, N> X, std::array<std::array<double, N>, N> Y)
{
...
template<int N>
inline std::array<std::array<double, N>, N> Rls<N>::scalar_mat(double x, std::array<std::array<double, N>, N> Y)
{
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            Y[i][j] *=x;
